...
const INSTRUCTIONS: Record<string, string> = {
  baseline: "Toggle ALL the settings at least once. When you're done, tap the 'Rate now' button.",
  onehandmode: "Toggle ALL the settings at least once. When you're done, tap the 'Rate now' button.",
  lefthand: "Toggle ALL the settings at least once. When you're done, tap the 'Rate now' button.",
};
